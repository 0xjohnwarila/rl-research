...
print('PART 1: Success! The example took {} seconds.'.format(duration))
...
print('PART 2: Success! The example took {} seconds.'.format(duration))
...
print('PART 3: Success! The example took {} seconds.'.format(duration))
...
print('PART 4: Success! The example took {} seconds.'.format(duration))
